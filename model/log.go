...
type Log struct {
	...
	ReasoningEffort   *string `json:"reasoning_effort" gorm:"type:varchar(128)"`
...
func reasoningEffortFromLogOther(other map[string]interface{}) *string {
	if other == nil {
		return nil
	}
	value, ok := other["reasoning_effort"].(string)
	if !ok {
		return nil
	}
	value = common.NormalizeReasoningEffortForLog(value)
	if value == "" {
		return nil
	}
	return &value
...
func RecordErrorLog(c *gin.Context, userId int, channelId int, modelName string, tokenName string, content string, tokenId int, useTimeSeconds int,
	...
	log := &Log{
		...
		ReasoningEffort:   reasoningEffortFromLogOther(other),
		Other:             otherStr,
	}
	err := createLog(log)
	if err != nil {
...
func RecordConsumeLog(c *gin.Context, userId int, params RecordConsumeLogParams) {
	...
	log := &Log{
		...
		RequestId:         requestId,
		UpstreamRequestId: upstreamRequestId,
		ReasoningEffort:   reasoningEffortFromLogOther(params.Other),
		Other:             otherStr,
	}
	err := createLog(log)
	if err != nil {
